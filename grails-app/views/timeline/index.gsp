...
<r:external uri="/webPlugins/fancybox/source/jquery.fancybox.css"/>
<r:external uri="/css/pages/feature_timeline2.css"/>
</head>
<body>
        	...
        	<div class="col-md-12">
                <ul class="timeline-v2">
                    ...
                    <li>
                        ...
                        <i class="cbp_tmicon rounded-x hidden-xs"></i>
                        <div class="cbp_tmlabel">
                            <h2>Supplementary Submission</h2>
