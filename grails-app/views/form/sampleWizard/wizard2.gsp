...
<!--<![endif]-->
<head>
<title>Ofwat Portal | Welcome...123</title>
<meta name="layout" content="ofwatMain"/>
<r:external uri="/webPlugins/sky-forms/version-2.0.1/css/custom-sky-forms.css"/>
</head>
        ...
        <div class="row">
        	...
        	<div class="col-md-3">
                ...
                <div class="margin-bottom-30">
                    <div class="headline"><h2>Complete your Details</h2></div>
            ...
            <div class="col-md-9">
                ...
                <form action="" id="sky-form" class="sky-form" novalidate="novalidate">
                    <header>Supporting Information</header>
                    ...
                    <fieldset>
                        <section>
                            <div class="inline-group">
                                <label class="radio"><input type="radio" name="radio-inline" checked=""><i class="rounded-x"></i>Option 1</label>
                                <label class="radio"><input type="radio" name="radio-inline"><i class="rounded-x"></i>Option 2</label>
                                <label class="radio"><input type="radio" name="radio-inline"><i class="rounded-x"></i>Option 3</label>
                            </div>
                        </section>                  
					...
					<fieldset>
                    	...
                    	<fieldset>
                   			<section>
                    		<g:link class="btn-u" event="back"><i class="fa fa-step-backward"></i>Back</g:link>
                    		<g:link class="btn-u" event="next" style="float:right">Next<i class="fa fa-step-forward"></i></g:link>
                    		</section>
                    	</fieldset>
                </form>         
                <!-- End Checkout-Form -->
